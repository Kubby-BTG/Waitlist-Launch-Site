...
const SocialMediaShareButtons = () => {
  return (
    <div className="flex gap-4 max-lg:row-start-1 lg:flex-col">
      <a href="#" className={"flex size-10 items-center justify-center rounded-full border border-primary/50"}>
        ...
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={"size-6"}>
          ...
          <defs>
            <clipPath id="clip0_380_21706">
              <rect width="16.6667" height="15.0667" fill="white" transform="translate(5.6665 6.3396)" />
            </clipPath>
          </defs>
        </svg>
      </a>
