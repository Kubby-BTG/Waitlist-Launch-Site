  ...
  return (
    <section data-slice-type={slice.slice_type} data-slice-variation={slice.variation} className={"bg-background-secondary"}>
      <div className="flex w-full flex-col md:flex-row md:justify-between">
        <div className={"container flex flex-col justify-center gap-6 pb-[350px] md:pb-3"}>
          <div>
        ...
        <div className={"bg-primary md:w-[150px]"}>
          <img src="/images/phone-hand-03.gif" className="-mt-[315px] md: ml-[100px] md:-mt-0" width={180} height={200} />
        </div>
      </div>
    </section>
  );
